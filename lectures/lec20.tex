...
\begin{remark}
    We keep assuming invertibility of the linear maps because the box volume Lemma \ref{lem:box-volume} doesn't quite apply if one of the intervals is degenerate. One can shows as aan exercise that non-invertible linear maps map any set to a null set. We won't be working with them, I think.
\end{remark}