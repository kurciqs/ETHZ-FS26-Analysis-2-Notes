...
\begin{lemma}[Hilbert-Schmidt norm]\label{lem:hilbert-schmidt-norm}
    For every $x \in \mathbb{R}^{n}$ and $M: \mathbb{R}^{n} \to \mathbb{R}^{m}$ linear, $ \left| Mx \right| \leq \lVert M \rVert_{2} \left| x \right|$. In particular, any linear map is Lipschitz.
\end{lemma}
\begin{proof}
    We have 
    \begin{align*}
...
\begin{eg}[Other norms on other spaces]
...
\begin{definition}[Inner product vector space]\label{def:inner_prod_vs}
    ...
    \begin{enumerate} 
        ...
        \item $\forall \alpha, \beta \in \mathbb{R}, u,v,w \in V: \langle \alpha v+ \beta u, w \rangle = \alpha \langle v,w \rangle + \beta \langle u,w \rangle$.
...
\begin{remark}[Global conventions]\label{rem:global_conventions}
