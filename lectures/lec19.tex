...
\begin{proof}
    ...
    \end{align*}
    Hence (if you find a dyadic decomposition and compute the volume, everybody knows this is true), we get for sufficiently big $p$
    \begin{align*}
...
\begin{proof}
    ...
    \begin{align*}
        F_{\epsilon} = \bigcup (a_{\ell} + [0,1)^{n})2^{-p} \implies F_{\epsilon}^{\circ } \subset \bigcup (a_{\ell} + (0,1)^{n})2^{-p}.
    \end{align*}
