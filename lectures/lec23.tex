...
\begin{eg}[Finishing the volume of the sphere]
	...
	\end{align*}
	One computes one after another, the integrals w.r.t. to variables $y_{1}, y_{2}, y_{3}$, treating all others as a constant, giving $\frac{4}{3}\pi$.
\end{eg}
...
\begin{definition}[Improper integral]\label{def:improp-int}
	Let $U \subset \mathbb{R}^{n}$ open, $f: U \to [0,\infty)$ continuous (and maybe \textit{not} defined at some points in $U$). Define the \textit{improper} integral
	\begin{align*}
