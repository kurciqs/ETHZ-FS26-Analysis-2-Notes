...
\begin{definition}[Interior, closure and boundary]\label{def:int_clos_bound}
    ...
    \begin{itemize} 
        ...
        \item The closure $\overline{ \Omega }= \left\{ x \in X \mid \exists (x_{n})_{n}^{\infty} \subset \Omega \text{ s.t. } x_{n} \to x \right\} = \bigcap \left\{ A \supset \Omega \mid A \text{ is closed} \right\}$\footnote{We still have to show the equality TODO: WHEN?}.
