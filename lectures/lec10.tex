...
\begin{corollary}[Permutation of partials]\label{cor:perm_partials}
...
\end{corollary}
\begin{proof}
    Follows from Schwarz Theorem \ref{thm:schwarz}, as any permutation can be written as a product of transpositions.
\end{proof}
