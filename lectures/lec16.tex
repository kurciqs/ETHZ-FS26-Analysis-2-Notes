...
\begin{theorem}[Implicit function theorem]\label{thm:impl-func-theorem}
	...
	Then $\exists U_{0} = B_{r}(x_{0}) \times B_{s}(y_{0}) \subset U$ and for any $\lambda \in \mathbb{R}$, there is a function $g: B_{r}(x_{0}) \to B_{s}(y_{0})$ such that,
	\begin{align*}
...
\begin{proof}
	...
	To get the formula for $Dg(x)$, we differentiate the identity $f(x,g(x)) = \lambda$ using the chain rule (check component-wise, it's a pain)
	\begin{align*}
